...
export const txnCategoryEnum = pgEnum("txn_category", ["add_money", "transfer", "payment"]);
export const txnStatusEnum = pgEnum("txn_status", ["success", "failed"]);
...
export const transactions = pgTable("transactions", {
  ...
  counterpartyWalletId: text("counterparty_wallet_id"),
  category: txnCategoryEnum("category").notNull(),
  note: text("note"),
